...
namespace Golden_Bekt_Development.Controllers
{
    ...
    [ApiController]
    public class Annual_reportController : ControllerBase
    {
        private readonly GenericService<Annual_report> _service;
        private readonly IMapper _mapper;
        private readonly IBunyimagesServices _bunny;
        public Annual_reportController(GenericService<Annual_report> service, IMapper mapper, IBunyimagesServices bunny)
        {
            _service = service;
            _mapper = mapper;
            _bunny = bunny;
        ...
        public async Task<IActionResult> Create([FromForm] Annual_reportCreatDto dto)
        {
        ...
        [HttpPut("{id}")]
        [Authorize(AuthenticationSchemes = "Bearer")]
        public async Task<IActionResult> Update(string id, [FromForm] Annual_reportCreatDto dto)
        {
            ...
            if (dto.ReportURL != null && dto.ReportURL.Length > 0)
            {
                ...
                existingEntity.ReportURL = $"https://this0is0my0pull0zone.b-cdn.net/programs/{uploadResult.FileName}";
            }
